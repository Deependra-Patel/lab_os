...
DEF_SYSCALL(Socket, SYS_SOCKET, int, (uchar_t type, int flags), ulong_t arg0 =
            type;
            ulong_t arg1 = flags;
            , SYSCALL_REGS_2)
...
DEF_SYSCALL(Receive, SYS_RECEIVE, int,
                (ulong_t id, void *buffer, ulong_t bufferSize), ulong_t arg0 =
            id;
            void *arg1 = buffer;
...
DEF_SYSCALL(Receive_From, SYS_RECEIVEFROM, int,
            ...
            void *arg4 = ipAddress;
            , SYSCALL_REGS_5)
DEF_SYSCALL(Close_Socket, SYS_CLOSESOCKET, int, (ulong_t id), ulong_t arg0 =
            id;
            , SYSCALL_REGS_1)
