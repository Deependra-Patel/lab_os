...
static union IP_Address s_inaddrBroadcast = {.address = INADDR_BROADCAST };
...
int IP_Dispatch_Table_Add(ushort_t type,
                          int (*dispatcher) (struct IP_Device *, IP_Address *,
                                             IP_Address *,
                                             struct Net_Buf *)) {
...
static int IP_Get_Address(struct Net_Device *device, IP_Address * ipAddress) {
...
int IP_Device_Configure(char *name, IP_Address * ipAddress, Netmask * netmask) {
