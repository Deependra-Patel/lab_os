...
extern int Net_Get_Route_Info(struct IP_Device **device,
                              IP_Address * ipAddress, IP_Address * network,
                              Netmask * subnet, bool * fGateway,
                              IP_Address * gateway);
extern int Net_Get_Route(struct IP_Device **device, IP_Address * ipAddress,
                         bool * fGateway, IP_Address * gateway);
extern int Net_Get_Route_Table(struct IP_Route *table, ulong_t maxEntries);
