...
DEF_SYSCALL(Arp, SYS_ARP, int, (uchar_t * ipAddress, uchar_t * macAddress),
            uchar_t * arg0 = ipAddress;
            uchar_t * arg1 = macAddress;
            , SYSCALL_REGS_2)

DEF_SYSCALL(Route_Add, SYS_ROUTEADD, int,
                (uchar_t * ipAddress, uchar_t * netmask, uchar_t * gateway,
                 char *ifaceName, ulong_t len), uchar_t * arg0 = ipAddress;
...
DEF_SYSCALL(IP_Send, SYS_IPSEND, int,
                (uchar_t * ipAddress, char *message, ulong_t messageLength),
            uchar_t * arg0 = ipAddress;
            char *arg1 = message;
